...
const displayNews = (data) => {
    ...
    const oneNewsHTML = `
            <div>
                ...
                <a href="#" class="block font-medium font-flex text-base text-primary-default w-10/12 tracking-wide mb-5">${headline.category || "General"}</a>
    ...
    const otherNewsHTML = otherNews.map(news => `
        <div class="flex items-start pl-14 mb-6">
          ...
          <div class="flex-1">
            ...
            <a href="#" class="block font-medium font-flex text-base text-primary-default tracking-wide w-10/12 mb-3">${news.category || "General"}</a>
          </div>
          <!-- Bagian Gambar -->
    ...
    const latestNewsHTML = latestNews.map(news => `
            <div>
                ...
                <div class="mt-3">
                    ...
                    <a href="#" class="block font-medium font-flex text-base text-primary-default tracking-wide mt-2">${news.category || "General"}</a>
                </div>
            </div>
      `).join('');
...
const displayCategoryNews = (dataScience, dataSports) => {
    ...
    const scienceNewsHTML = scienceNews.map(newsScience => `
            <div>
                ...
                <div class="mt-3">
                    <a href="${newsScience.link}" class="block w-full font-serif font-semibold text-lg text-dark hover:underline">${newsScience.title}</a>
                    <a href="#" class="block font-medium font-flex text-base text-primary-default tracking-wide mt-2">${newsScience.category || "General"}</a>
                </div>
            </div>
    `).join('');
    ...
    const sportsNewsHTML = sportsNews.map(newsSports => `
            <div>
                ...
                <div class="mt-3">
                    ...
                    <a href="#" class="block font-medium font-flex text-base text-primary-default tracking-wide mt-2">${newsSports.category || "General"}</a>
                </div>
            </div>
    `).join('');
